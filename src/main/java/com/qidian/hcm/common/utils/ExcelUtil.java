...
public final class ExcelUtil {
     ...
     * @return
     */
    public static HSSFWorkbook createWorkbook(String title, String[] rowName, List<Object[]> dataList) {
     ...
     * 设置表头单元格样式
     */
    public static HSSFCellStyle getColumnHeaderStyle(HSSFWorkbook workbook) {
        // 设置字体
    ...
    public static List<LinkedHashMap> parseExcelToJson(String filePath) {
        List<LinkedHashMap> list = new ArrayList<>();
        try (
                InputStream in = java.nio.file.Files.newInputStream(Paths.get(filePath))
        ) {
            list = parseExcelToJson(in);
        } catch (IOException e) {
    ...
    public static List<LinkedHashMap> parseExcelToJson(InputStream inputStream) {
        List<LinkedHashMap> list = new ArrayList();
        try (
