...
import static com.qidian.hcm.common.utils.ResultCode.MESSAGE_SEND_FAILED;
import static com.qidian.hcm.common.utils.ResultCode.USER_NOT_EXIST;
...
public class VerificationService {
    ...
    public void sendMessage(String phone, String verificationCode) throws ClientException {
        IClientProfile profile = DefaultProfile.getProfile(CN_HANGZHOU, hcmConfig.accessKeyId,
                hcmConfig.accessKeySecret);
