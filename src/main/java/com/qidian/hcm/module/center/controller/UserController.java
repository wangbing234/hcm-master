...
public class UserController {
    ...
    public Result loginByPassword(@RequestBody @Valid LoginRequest loginRequest) {
    ...
    public Result loginByVerification(@RequestBody SMSLoginRequest request) {
    ...
    public Result getVerificationCode(@PathVariable("phone") String phone) {
    ...
    public Result initCompanyAdminData(@RequestBody @Valid InitCompanyAdminRequest request) {
    ...
    public Result addNotActiveUser(@RequestBody @Valid AddNotActiveUserRequest request) {
    ...
    public Result updateUserPhone(@RequestBody @Valid UpdateUserPhoneRequest request) {
    ...
    public Result updateBaseInfo(@RequestBody BaseInfoRequest request, @PathVariable(name = "id") Long userId) {
