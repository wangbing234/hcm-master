...
public class CompanyController {
    ...
    public Result getCompanyList(@RequestParam(value = "active") Integer active,
    ...
    @PreAuthorize("hasAuthority('backend|company|EDIT') or hasRole('ROLE_ADMIN')")
    @PutMapping("/enable")
    public Result enableCompanyById(@RequestBody EnableCompanyRequest request) {
    ...
    @ApiOperation("创建公司")
    @PostMapping()
    public Result createCompany(@RequestBody @Valid CreateCompanyRequest createCompanyRequest) {
    ...
    @ApiOperation("修改公司信息")
    @PutMapping("/{id}")
    public Result updateCompany(@PathVariable Long id, @RequestBody @Valid UpdateCompanyRequest updateCompanyRequest) {
