...
public class SalarySettingService {
    ...
    public String saveOrUpdateCurrentCycleMonth() {
        String nextMonthStr;
        Optional<SalarySetting> salarySettingOptional = salarySettingRepository.findByKey(
                SalarySettingEnum.CURRENT_CYCLE_MONTH.getKey());
        if (salarySettingOptional.isPresent()) {
            ...
            SalarySetting setting = new SalarySetting(SalarySettingEnum.CURRENT_CYCLE_MONTH.getName(),
                    SalarySettingEnum.CURRENT_CYCLE_MONTH.getKey(), nextMonthStr);
            salarySettingRepository.save(setting);
        }
        return nextMonthStr;
    }
