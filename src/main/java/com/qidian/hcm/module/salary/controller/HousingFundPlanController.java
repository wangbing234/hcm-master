...
public class HousingFundPlanController {
    ...
    @PostMapping
    public Result addHousingFunPlan(@RequestBody @Valid HousingFundPlanDTO housingFundPlanDTO) {
    ...
    @PutMapping("{id}")
    public Result updateHousingFunPlan(@PathVariable Long id,
                                       @RequestBody @Valid HousingFundPlanDTO housingFundPlanDTO) {
    ...
    @DeleteMapping("{id}")
    public Result deleteHousingFundPlan(@PathVariable Long id) {
