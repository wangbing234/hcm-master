...
public class BasicSalaryController {
    ...
    @GetMapping("records")
    @ResponseBody
    public Result<Page<SalaryRecordMonthlyResponse>> getSalaryRecords(@Valid FilterSalaryRecordRequest recordRequest) {
    ...
    @ResponseBody
    public Result<Page<SalaryReportAllResponse>> getSalaryMonthReport(
            @Valid FilterSalaryRecordRequest recordRequest, @PathVariable(value = "month") String month) {
    ...
    @PostMapping("import")
    @ResponseBody
    public Result importSalaryMonthExcel(@RequestBody @Valid UploadFileRequest uploadFileRequest) {
    ...
    @GetMapping("export")
    public void exportSalaryMonthExcel(@JsonFormat(pattern = "yyyy-MM", timezone = "GMT+8") String month,
    ...
    private void writeFileToResponse(HttpServletResponse response, String fileName, HSSFWorkbook wb) {
        try (
