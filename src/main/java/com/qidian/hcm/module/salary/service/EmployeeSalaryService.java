...
public class EmployeeSalaryService {
    ...
    public List<EmployeeSalaryHistoryResponse> getSalaryHistory(Long employeeId) {
        ...
        List<EmployeeSalaryHistoryResponse> salaryHistoryResponses =
                newArrayListWithExpectedSize(salaryHistoryList.size());
    ...
    public EmployeeSalaryDetailResponse getEmployeeSalaryInfo(Long employeeId) {
        ...
        if (Objects.nonNull(employeefinancial.getThresholdId())) {
            Optional<SalaryThreshold> salaryThresholdOptional =
                    salaryThresholdRepository.findById(employeefinancial.getThresholdId());
    ...
    public EmployeeSecurityDetailResponse getEmployeeSecurityDetail(Long employeeId) {
        ...
        if (!StringUtils.isEmpty(employeeFinancial.getSocialSecurityPlanId())) {
            Optional<SocialSecurityPlan> socialSecurityPlanOptional = socialSecurityPlanRepository
                    .findById(employeeFinancial.getSocialSecurityPlanId());
        ...
        if (!StringUtils.isEmpty(employeeFinancial.getHousingFundPlanId())) {
            Optional<HousingFundPlan> housingFundPlanOptional = housingFundPlanRepository
                    .findById(employeeFinancial.getHousingFundPlanId());
     ...
     * @param employeeId
     */
    private void salaryCalculate(Long employeeId) {
        SalaryItem salaryItem = salaryItemRepository.findByCode(SalaryFormulaIKeyword.SALARY_CODE)
    ...
    public void adjustSalary(Long employeeId, SalaryAdjustRequest salaryAdjustRequest) {
        validateOrGetEmployee(employeeId);
        EmployeeFinancial employeeFinancial = employeeFinancialRepository.findByEmployeeId(employeeId)
                .orElseThrow(() -> new BizException(ResultCode.SOCIAL_SECURITY_NOT_EXISTS));
    ...
    @Transactional
    public void editEmployeeSecurity(Long employeeId,
                                     EmployeeSecurityPlanRequest employeeSecurityPlanRequest) {
        validateOrGetEmployee(employeeId);
        socialSecurityPlanRepository.findById(employeeSecurityPlanRequest.getSocialSecurityPlanId())
                .orElseThrow(() -> new BizException(ResultCode.SOCIAL_SECURITY_NOT_EXISTS));
    ...
    @Transactional
    public void editEmployeeFundPlanInfo(Long employeeId,
                                         EmployeeHousingFundPlanRequest employeeHousingFundPlan) {
        validateOrGetEmployee(employeeId);
        housingFundPlanRepository.findById(employeeHousingFundPlan.getHousingFundPlanId())
    ...
    @Transactional
    public void editEmployeeThreshold(Long employeeId,
                                      EmployeeThresholdRequest employeeThresholdRequest) {
        validateOrGetEmployee(employeeId);
        Optional<EmployeeFinancial> financialOptional = employeeFinancialRepository.findByEmployeeId(employeeId);
        EmployeeFinancial employeeFinancial;
        if (financialOptional.isPresent()) {
