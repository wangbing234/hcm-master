...
public class SocialSecurityPlanController {
    ...
    @PostMapping
    public Result addSecurityPlan(@RequestBody @Valid SocialSecurityPlanDTO socialSecurityPlanDTO) {
    ...
    @PutMapping("{id}")
    public Result updateSecurityPlan(@PathVariable Long id,
                                     @RequestBody @Valid SocialSecurityPlanDTO socialSecurityPlanDTO) {
    ...
    @DeleteMapping("{id}")
    public Result deleteSecurityPlan(@PathVariable Long id) {
