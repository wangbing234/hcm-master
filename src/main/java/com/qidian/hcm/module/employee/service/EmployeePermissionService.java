...
public class EmployeePermissionService {
    ...
    private void mergePermissionData(List<PermissionMetaDataDTO> permissionData1,
                                     List<PermissionMetaDataDTO> permissionData2,
                                     Map<Long, OrganizationEntity> organizationMap) {
