...
public class EmployeeEmergencyContactService {
    ...
    @Transactional
    public void saveEmployeeEmergencyContact(Long employeeId,
                                             List<EmployeeEmergencyContactDTO> employeeEmergencyContactDTOList) {
        employeeEmergencyContactRepository.deleteAllByEmployeeId(employeeId);
        //emergencyContact表操作
        List<EmployeeEmergencyContact> employeeEmergencyContactList =
                newArrayListWithExpectedSize(employeeEmergencyContactDTOList.size());
    ...
    List<EmployeeEmergencyContactDTO> getEmergencyContactsDTOList(Long employeeId) {
        List<EmployeeEmergencyContact> employeeEmergencyContactList =
                employeeEmergencyContactRepository.findAllByEmployeeId(employeeId);
        List<EmployeeEmergencyContactDTO> emergencyContacts =
                newArrayListWithExpectedSize(employeeEmergencyContactList.size());
