...
public class EmployeeWorkExperienceService {
    ...
    @Transactional
    public void saveEmployeeWorkExperience(Long employeeId,
                                           List<EmployeeWorkExperienceDTO> employeeWorkExperienceDTOList) {
        employeeWorkExperienceRepository.deleteAllByEmployeeId(employeeId);
        //workExperience表操作
        List<EmployeeWorkExperience> employeeWorkExperienceList =
                newArrayListWithExpectedSize(employeeWorkExperienceDTOList.size());
    ...
    List<EmployeeWorkExperienceDTO> getEmployeeWorkExperienceDTOList(Long employeeId) {
        List<EmployeeWorkExperience> employeeWorkExperienceList =
                employeeWorkExperienceRepository.findAllByEmployeeId(employeeId);
        List<EmployeeWorkExperienceDTO> employeeWorkExperienceDTOList =
                newArrayListWithExpectedSize(employeeWorkExperienceList.size());
