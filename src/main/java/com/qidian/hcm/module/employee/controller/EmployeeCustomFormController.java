...
public class EmployeeCustomFormController {
    ...
    public Result sortForm(@RequestBody List<Long> ids) {
    ...
    public Result createCustomizedForms(@RequestBody @Valid CustomizedFormsRequest addCustomizedFormsRequest) {
    ...
    public Result updateCustomizedForms(@PathVariable Long id,
                                        @RequestBody @Valid CustomizedFormsRequest addCustomizedFormsRequest) {
    ...
    @ApiImplicitParam(name = "id", value = "自定义表单ID", dataType = "long", paramType = "path", required = true)
    public Result deleteCustomizedForms(@PathVariable Long id) {
    ...
    @ApiImplicitParam(name = "id", value = "自定义表单ID", dataType = "long", paramType = "path", required = true)
    public Result toggleActiveCustomizedForms(@PathVariable Long id, @RequestBody @Valid EnableRequest enableRequest) {
    ...
    @ApiImplicitParam(name = "id", value = "自定义表单ID", dataType = "long", paramType = "path", required = true)
    public Result<CustomizedFormResponse> getCustomizedFormDetail(@PathVariable Long id) {
